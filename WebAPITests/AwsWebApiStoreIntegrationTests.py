...
class AwsWebApiFunctionalTests(unittest.TestCase):
    ...
    def test_getting_shops_returns_code_200_and_list_of_json_objects(self):
        ...
        self.assertTrue(results[0]['uuid'] == '9b70ba73-165c-44b4-a0a0-3acffaab19b7')
        self.assertTrue(results[0]['_links']['self'] == '/Test/shops/9b70ba73-165c-44b4-a0a0-3acffaab19b7')
        self.assertTrue(results[1]['name'] == 'Drawbridge Games')
        self.assertTrue(results[1]['primaryEmail'] == 'test@drawbridgegames.com')
        self.assertTrue(results[1]['uuid'] == '726c34d6-3e69-4788-a937-97e416c0626c')
        self.assertTrue(results[1]['_links']['self'] == '/Test/shops/726c34d6-3e69-4788-a937-97e416c0626c')

    def test_registering_valid_shop_returns_code_201_and_sets_location_header(self):
        test_shop = {'name':'Drawbridge Games', 'primaryEmail':'test@drawbridgegames.com', 'uuid':'00000000-0000-0000-0000-000000000000'}
    ...
    def test_getting_a_valid_shop_returns_200_and_json_object(self):
        ...
        self.assertTrue(r.json()['name'] == 'Drawbridge Games')
        self.assertTrue(r.json()['primaryEmail'] == 'test@drawbridgegames.com')
        self.assertTrue(r.json()['uuid'] == '726c34d6-3e69-4788-a937-97e416c0626c')
        self.assertTrue(r.json()['_links']['self'] == '/Test/shops/726c34d6-3e69-4788-a937-97e416c0626c')
    ...
    def test_valid_update_an_existing_shop_returns_code_204(self):
        test_shop = {'name':'Drawbridge Games', 'primaryEmail':'test2@drawbridgegames.com', 'uuid':'726c34d6-3e69-4788-a937-97e416c0626c'}
        r = requests.put(url = BASE_URL + '/shops/726c34d6-3e69-4788-a937-97e416c0626c', json = test_shop)
        self.assertTrue(r.status_code == 204)
    
    def test_invalid_update_an_existing_shop_returns_code_204(self):
